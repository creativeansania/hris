...
import { Plus, Edit2, Trash2, MapPin, Compass, AlertCircle, Navigation } from 'lucide-react';
import {
  getOfficeLocations,
...
export default function OfficeLocationsPage() {
  ...
  const handleGetCurrentLocation = () => {
    if (!navigator.geolocation) {
      alert('Peramban tidak mendukung deteksi geolokasi.');
      return;
    }
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (err) => {
        alert(`Gagal mengambil koordinat saat ini: ${err.message}`);
      }
    );
  };
