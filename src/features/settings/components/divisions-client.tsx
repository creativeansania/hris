...
import { Plus, Edit2, Trash2, Building2, User, AlertCircle } from 'lucide-react';
        ...
        {isLoading ? (
          ...
          <div className="py-12 text-center text-xs text-slate-400 border border-dashed border-slate-800 rounded-xl">
            ...
            <p className="text-slate-500 mt-0.5">
              Klik tombol Tambah Divisi untuk mulai membuat struktur organisasi.
            </p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs text-slate-300">
              ...
              <tbody className="divide-y divide-slate-800/60">
                {divisions.map((div) => {
                  const kepala =
                    div.kepala_divisi || employees.find((e) => e.id === div.kepala_divisi_id);
